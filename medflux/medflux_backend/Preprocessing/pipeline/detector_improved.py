...
DEFAULT_RECO = {"mode": "native", "dpi": 200, "psm": 6, "tables_mode": "light", "lang": "deu+eng"}
...
def detect_file_type_improved(
    ...
    return FileTypeResult(path, ext, mime, UNKNOWN, False, {"note": "unknown"}, confidence=0.3, recommended={"mode": "mixed", "tables_mode": "light", "lang": "deu+eng"})
