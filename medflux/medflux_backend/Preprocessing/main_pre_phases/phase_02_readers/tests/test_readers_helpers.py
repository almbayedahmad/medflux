...
from medflux_backend.Preprocessing.main_pre_phases.phase_02_readers.core_functions.readers_core_params import (
...
def test_compute_readers_run_metadata_uses_override_pipeline() -> None:
    run_meta = compute_readers_run_metadata(pipeline_id="custom.pipeline")
