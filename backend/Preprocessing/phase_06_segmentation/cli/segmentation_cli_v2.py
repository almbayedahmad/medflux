# PURPOSE:
#   Unified CLI entrypoint for the segmentation phase (v2 scaffold).
# OUTCOME:
...
from ..api import SegmentationRunner, PHASE_ID, PHASE_NAME_DEFAULT


def main(argv: list[str] | None = None) -> int:
    """Run the segmentation phase CLI wrapper using the shared toolkit.
