# PURPOSE:
#   Core classifier for the detect_type stage.
#
# OUTCOME:
#   Computes file type classification and recommended readers settings for each
#   input item and summarizes results for persistence and validation.
#
# INPUTS:
#   - generic_items: sequence of mappings with file path keys.
#   - detection_overrides: optional tunables (sample_pages, thresholds).
#
# OUTPUTS:
#   - Mapping with unified_document, stage_stats, and per-item results.
#
# DEPENDENCIES:
#   - Local helpers_detect and schema summary utilities.
...
from ..domain.helpers_detect import process_detect_type_many
