# PURPOSE:
#   Table processing and record construction for readers.
#
# OUTCOME:
#   Builds table records and geometry from detected cells to enrich readers
#   outputs and summaries.
#
# INPUTS:
#   - Parsed cell geometry, OCR/native text blocks.
#
# OUTPUTS:
#   - TableRecord instances and auxiliary metrics (in-memory).
#
# DEPENDENCIES:
#   - Local schemas and ops; standard library only.
