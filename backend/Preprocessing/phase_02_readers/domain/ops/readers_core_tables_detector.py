# PURPOSE:
#   Light-weight table detector heuristics for readers.
#
# OUTCOME:
#   Flags candidate tables and computes coarse geometry for downstream table
#   extraction modules.
#
# INPUTS:
#   - Page images/blocks and detector thresholds.
#
# OUTPUTS:
#   - Candidate flags and counts (in-memory), no direct IO.
#
# DEPENDENCIES:
#   - Local settings; optional imaging libs.
