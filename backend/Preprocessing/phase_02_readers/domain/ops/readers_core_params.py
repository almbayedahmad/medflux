# PURPOSE:
#   Compute readers runtime parameters and build ReaderOptions.
#
# OUTCOME:
#   Normalizes detection metadata, config defaults, and per-item overrides into
#   deterministic parameters and a ReaderOptions instance.
#
# INPUTS:
#   - detect_meta, config options, item overrides.
#
# OUTPUTS:
#   - Dict of parameters and a ReaderOptions dataclass instance.
#
# DEPENDENCIES:
#   - Local readers schemas; standard library only.
