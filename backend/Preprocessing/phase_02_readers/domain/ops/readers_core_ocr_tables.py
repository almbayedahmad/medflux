# PURPOSE:
#   Table extraction helpers for readers leveraging OpenCV.
#
# OUTCOME:
#   Detects and extracts table structures from images/pages to enrich readers
#   outputs and summaries.
#
# INPUTS:
#   - Page images/paths and OCR context.
#
# OUTPUTS:
#   - Extracted table data appended to orchestrator aggregates (in-memory).
#
# DEPENDENCIES:
#   - Optional: OpenCV (cv2), NumPy, pytesseract.
