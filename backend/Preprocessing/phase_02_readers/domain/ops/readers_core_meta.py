# PURPOSE:
#   Assemble readers document metadata payload.
#
# OUTCOME:
#   Produces a structured doc_meta mapping combining detection, encoding, and
#   readers runtime summaries suitable for downstream phases and validation.
#
# INPUTS:
#   - Detect meta, encoding meta, readers results, timing info, run identifiers.
#
# OUTPUTS:
#   - JSON-serializable dict used by IO writer to persist doc_meta.json.
#
# DEPENDENCIES:
#   - Local readers ops and schemas; standard library only.
