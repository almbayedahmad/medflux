# PURPOSE:
#   Native document processing helpers (text, PDF, DOCX) for readers.
#
# OUTCOME:
#   Extracts text and basic page stats without OCR, feeding orchestrator
#   records and downstream aggregation.
#
# INPUTS:
#   - Paths to text/PDF/DOCX files and orchestrator state.
#
# OUTPUTS:
#   - In-memory page records, blocks, and timing entries updated on orchestrator.
#
# DEPENDENCIES:
#   - Optional: PyMuPDF (fitz), PIL; standard library.
