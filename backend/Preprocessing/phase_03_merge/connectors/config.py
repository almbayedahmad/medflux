# PURPOSE:
#   Minimal config connector for phase_03_merge (v2 scaffold).
# OUTCOME:
...
def connect_merge_config_connector(stage_name: str = "merge") -> Dict[str, Any]:
    """Return the effective configuration for the merge phase.
