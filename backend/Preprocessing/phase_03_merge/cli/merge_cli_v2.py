# PURPOSE:
#   Unified CLI entrypoint for the merge phase (v2 scaffold).
# OUTCOME:
...
from ..api import MergeRunner, PHASE_ID, PHASE_NAME_DEFAULT


def main(argv: list[str] | None = None) -> int:
    """Run the merge phase CLI wrapper using the shared toolkit.
