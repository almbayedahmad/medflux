# PURPOSE:
#   Minimal config connector for phase_10_offsets (v2 scaffold).
# OUTCOME:
...
def connect_offsets_config_connector(stage_name: str = "offsets") -> Dict[str, Any]:
    """Return the effective configuration for the offsets phase.
