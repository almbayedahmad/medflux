# Provenance Stage (phase_09_provenance)

## Purpose
Capture and persist provenance for inputs, processing steps, and outputs to support auditability and traceability.

## Workflow (v2)
- API: api.py
- CLI: cli/provenance_cli_v2.py
...
```
python -m backend.Preprocessing.phase_09_provenance.cli.provenance_cli_v2 --help
```
...
```
medflux phase-provenance --inputs path/to/file --output-root ./.artifacts/provenance
```

## Examples

- Umbrella CLI:
  `\n  medflux phase-provenance --inputs samples/Sample.txt --output-root ./.artifacts/provenance\n  `\n- Phase v2 CLI:
  `\n  python -m backend.Preprocessing.phase_09_provenance.cli.provenance_cli_v2 --inputs samples/Sample.txt --output-root ./.artifacts/provenance\n  `\n
