# PURPOSE:
#   Minimal config connector for phase_09_provenance (v2 scaffold).
# OUTCOME:
...
def connect_provenance_config_connector(stage_name: str = "provenance") -> Dict[str, Any]:
    """Return the effective configuration for the provenance phase.
