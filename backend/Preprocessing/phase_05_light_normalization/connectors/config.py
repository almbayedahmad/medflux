# PURPOSE:
#   Minimal config connector for phase_05_light_normalization (v2 scaffold).
# OUTCOME:
...
def connect_light_normalization_config_connector(stage_name: str = "light_normalization") -> Dict[str, Any]:
    """Return the effective configuration for the light_normalization phase.
