# Light Normalization Stage (phase_05_light_normalization)

## Purpose
Apply lightweight normalization to texts and metadata fields to prepare for segmentation.

## Workflow (v2)
- API: api.py
- CLI: cli/light_normalization_cli_v2.py
...
```
python -m backend.Preprocessing.phase_05_light_normalization.cli.light_normalization_cli_v2 --help
```
...
```
medflux phase-light-normalization --inputs path/to/file --output-root ./.artifacts/light-normalization
```

## Examples

- Umbrella CLI:
  `\n  medflux phase-light_normalization --inputs samples/Sample.txt --output-root ./.artifacts/light_normalization\n  `\n- Phase v2 CLI:
  `\n  python -m backend.Preprocessing.phase_05_light_normalization.cli.light_normalization_cli_v2 --inputs samples/Sample.txt --output-root ./.artifacts/light_normalization\n  `\n
