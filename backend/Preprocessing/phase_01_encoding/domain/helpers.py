# PURPOSE:
#   Encoding detection and normalization utilities migrated from
#   internal_helpers.encoding_helper_detection to the domain layer.
#
# OUTCOME:
#   Provides stable, import-light helpers for the phase domain and services,
#   enabling retirement of the legacy internal_helpers package.
#
# INPUTS:
#   - File paths to inspect and optional parameters (sample sizes, newline policy).
#
# OUTPUTS:
#   - Data classes and plain dicts describing encoding detection and
