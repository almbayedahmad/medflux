...
- [ ] Create required subdirectories (core_functions, pipeline_workflow, schemas, tests, docs, assets, common_files)
...
### 5) Code Generation
- [ ] Generate core functions modules
- [ ] Generate pipeline workflow entry
